...
<?php $table_heading = "Product Setup";?>
<?php include 'include/sidebar.php';?>
<?php include 'include/body-top.php';?>
 <?php
        $tbl_name="products";        //your table name
        $targetpage = "product_setup.php";  //your file name  (the name of this file)
    ...
    if(isset($_POST['submit']))
    {
           ...
           $products_position = $_POST['products_position'];
           $SQL = "SELECT * FROM $tbl_name WHERE `is_deleted` = 0 AND `products_name` = '$products_name' OR `products_position` = '$products_position'  ";
            $COUNT = mysqli_num_rows(mysqli_query($con,$SQL));
            if($COUNT < 1):
                
               $sql = "INSERT INTO $tbl_name ( `products_name` , `products_position` ,  `created_by` , `created_on`) VALUES(  '$products_name' , '$products_position', '$user_no', '$CURR_TIME')";
                $result = mysqli_query($con,$sql);
                if($result)
                {
    ...
    if(isset($_POST['update']))
    {
        ...
        echo    $SQL = "SELECT * FROM $tbl_name WHERE `is_deleted` = 0 AND (`products_name` = '$products_name' OR `products_position` = '$products_position') AND `products_no` != '$products_no'";
            $COUNT = mysqli_num_rows(mysqli_query($con,$SQL));
            if($COUNT < 1): 
               
             echo   $sql = "UPDATE $tbl_name SET   `products_name` = '$products_name' , `products_position` = '$products_position' , `is_updated` = 1, `updated_by` = $user_no ,`updated_on` = '$CURR_TIME'  WHERE products_no = $products_no";
                $result = mysqli_query($con,$sql);
                if($result)
                {
...
?> 
    ...
    ?>
     ...
     <div class="form-group " <?php if($mgs=='')echo "style='display:none;'" ?>>
      ...
      <div class="form-group ">
        ...
        <div class="form-group ">
            <label for="products_position" class="control-label col-lg-3">Product Position </label>
            <div class="col-lg-5">
                <input class=" form-control" id="" name="products_position" type="text" value="<?=$result['products_position']?>" required />
            </div>
    ...
    <form class="cmxform form-horizontal " id="signupForm" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group ">
            <label for="product_position" class="control-label col-lg-3">Product Positon </label>
            <div class="col-lg-5">
                <input class=" form-control" id="" name="products_position" type="text"  required />
            </div>
...
?>
    ...
    <table   class="table table-bordered table-hover table-responsive table-condensed table-striped dataTable col-xs-12 col-sm-12 col-md-6 col-lg-6 ">
        <tr>
            ...
            <th><center>Products Position</center></th>
