...
<?php
    ...
    {          
            ...
            $SQL = "SELECT * FROM $tbl_name WHERE `is_deleted` = 0 AND `title_h1` = '$title_h1' ";
            ...
            if($COUNT < 1):
                ...
                if ($_FILES["image_url"]["error"] > 0) {
                 ...
                 $sql = "INSERT INTO $tbl_name SET `title_h1` = '$title_h1', `image_url` = '$image_url', `created_by`='$user_no', `created_on`='$CURR_TIME'";
    ...
    if(isset($_POST['update']))
    {
            ...
            $SQL = "SELECT * FROM $tbl_name WHERE `is_deleted` = 0 AND `title_h1` = '$title_h1' AND `slider_id` != '$slider_id'";
            $COUNT = mysqli_num_rows(mysqli_query($con,$SQL));
            if($COUNT < 1): 
                if ($_FILES["image_url"]["error"] > 0) {
              ...
              $sql = "UPDATE $tbl_name SET   `title_h1` = '$title_h1' , `image_url` = '$image_url' , `is_updated` = 1, `updated_by` = $user_no ,`updated_on` = '$CURR_TIME'  WHERE slider_id = $slider_id";
                $result = mysqli_query($con,$sql);
                if($result)
                {
